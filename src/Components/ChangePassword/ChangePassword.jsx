...
export default function ChangePassword() {
  ...
  const handleChangePassword = async (formValues) => {
    try {
      ...
      const { data } = await axios.post("http://bookevent.runasp.net/api/Auth/Change-Password", formValues,
        {
          headers: {
  ...
  return (
    <div className='bg-gradient-to-b from-fuchsia-600 to-blue-950 py-20'>

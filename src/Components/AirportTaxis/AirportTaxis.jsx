...
import taxibackgroun from '../../assets/taxi new yourk.jpg';
...
export default function CategoriesList({ selectedCategoryId }) {
  ...
  useEffect(() => {
    fetchEvents(selectedCategoryId || 8, pageIndex);
  ...
  const handleBook = async (event) => {
    ...
    const result = await createBook({
      eventId: event.id,
      categoryId: selectedCategoryId || 8,
    });
    ...
    <div className="px-6 mb-12">
      ...
      <div className="sm:flex items-center justify-center gap-8 px-8 py-4">
        <div className="sm:w-1/2">
          <img className="w-full h-[400px] object-cover rounded-md shadow" src={taxibackgroun} alt="Taxi" />
        </div>
        <div className="sm:w-1/2 mt-5 sm:mt-0">
          <h2 className="text-3xl font-bold mb-4">Book Your Taxi Today</h2>
          <p className="text-lg text-gray-700">
            Find reliable taxi services and book your ride effortlessly with our easy-to-use booking system.
            Enjoy a comfortable and hassle-free journey, whether it's a quick trip across town or a longer ride.
          </p>
        </div>
      </div>
